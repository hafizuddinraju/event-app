...
const HappyClients = () => {
    ...
    return (
          ...
          >
         <div className="flex text-white relative justify-around items-center bg-[url('https://i.ibb.co/9WNmSLG/beautiful-pink-decorated-wedding-serving-with-centerpiece-lightening-candles-8353-10052.webp')]   py-32" style={{
