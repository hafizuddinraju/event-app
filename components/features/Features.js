    ...
    return (
        <div className='my-20'>
            ...
            <div className='flex flex-wrap justify-around mt-10'>
                <div className='h-44 w-44 p-5 hover:border hover:border-sky-300 mb-3 shadow-md md:shadow-none'>
                ...
                <div className='h-44 w-44 p-3 hover:border hover:border-sky-300 mb-3 shadow-md md:shadow-none'>
                    <div className='flex justify-center align-middle'>
