      ...
      <section className='bg-[#fbf9f9] py-28'>
          <div className=' max-w-screen-xl mx-auto '>
            ...
            <div className='flex  flex-wrap justify-around mt-10'>
                <div className={`h-44 ${styles.feature_card_css} shadow-black w-44 p-5 hover:border hover:border-sky-300  shadow-lg sm:shadow-none`}>
                ...
                <div className={`h-44 ${styles.feature_card_css} shadow-black w-44 p-3 hover:border hover:border-sky-300  shadow-lg sm:shadow-none`}>
                    <div className='flex justify-center align-middle'>
