                    ...
                    {alluser?.map((user) => {
                      return (
                        ...
                        >
                          ...
                          <td
                            onClick={() => UpdateToAdmin(user?.email)}
                            className="px-6 py-4"
                          >
                            {user?.role == "User" ? (
                              <div className="bg-gray-500 cursor-pointer  text-white w-1/2 text-center rounded-lg">
                                {user?.role}
                              </div>
                            ) : (
                              <div className="bg-sky-500 cursor-pointer text-white w-1/2 text-center rounded-lg">
                                {user?.role}
                              </div>
                            )}
                          </td>
